<?php
	class  jsonShowEjecucionInfoFail_Test extends PHPUnit_Framework_TestCase{ 

		public function test_show_ejecucion_info_fail(){
			echo ' >>>>>>>>>> test_show_ejecucion_info Correcta<<<<<<<<<<';

			$url = 'http://186.146.248.97:8585/proyecto_diplomado/web/app_dev.php/asignacion/1/4/docente';
